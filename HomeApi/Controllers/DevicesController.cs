...
namespace HomeApi.Controllers
{
    ...
    public class DevicesController : ControllerBase
    {
        ...
        {
            var checkDevice = await _devices.GetDeviceByName(device.Name);
            if (checkDevice is null)
                return StatusCode(400, $"Ошибка: Устройство {device.Name} не найдено.");
            
            await _devices.DeleteDevice(checkDevice);
            return StatusCode(201, $"Устройство {device.Name} успешно удалено.");
        }
    }
}